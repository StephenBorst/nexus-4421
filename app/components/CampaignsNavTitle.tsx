...
export function CampaignsNavTitle({ title }: { title: string }) {
  return (
    ...
    >
      <span className="inline-flex size-[20px] shrink-0 items-center justify-center" aria-hidden="true">
...
function CampaignsExternalArrowIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 6.5 6.5" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
      <path d="M0.5 0V1H4.795L0 5.795L0.705 6.5L5.5 1.705V6H6.5V0H0.5Z" fill="currentColor" fillOpacity={0.98} />
    </svg>
  );
}